...
INSERT INTO products (name, price, can_be_returned) VALUES ('iPhone',455.99,true);
...
--   Display only the products that have a price in between 22.50 
--   and 99.99.
SELECT  name FROM products WHERE price BETWEEN 22.50 AND 99.99;  

--   There’s a sale going on: Everything is $20 off! Update the 
